...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <%
    String email=session.getAttribute("email").toString(); //retriev
    %>
    
            <center><h2>Hospital Management System</h2></center>
            <h2><a href=""><%out.println(email); %> <i class='fas fa-user-alt'></i></a></h2>
            <a href="home.jsp">Home<i class="fa fa-institution"></i></a>
            <a href="myCart.jsp">Appointed Doctor<i class='fas fa-cart-arrow-down'></i></a>
             <a href="myPrescription.jsp">Prescrited Doctor <i class="fab fa-elementor"></i></a>
