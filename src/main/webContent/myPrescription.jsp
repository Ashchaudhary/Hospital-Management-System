...
<body>
<div style="color: white; text-align: center; font-size: 30px;">My Prescripted Doctor<i class='fab fa-elementor'></i></div>
<table>
        <thead>
          <tr>
            ...
            <th scope="col">Prescripted Date</th>
             <th scope="col">Prescription Starting Date</th>
